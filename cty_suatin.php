...
<div class="container mt-4">
    ...
    <form method="POST">
        ...
        <div class="mb-3"><label>Yêu cầu</label><textarea name="requirements" class="form-control" rows="4" required><?php echo $job['requirements']; ?></textarea></div>
        <div class="mb-3"><label>Email liên hệ</label><input type="email" name="contact_email" class="form-control" value="<?php echo $job['contact_email']; ?>" required></div>
